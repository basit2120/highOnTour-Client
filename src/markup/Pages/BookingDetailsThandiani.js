...
const tourDay = [
  ...
  },
  {
    image: require('./../../images/our-work/pic1.jpg'),
    day: 1,
    title: 'Abbotabad to Thandiani.',
    desc:
      'Arrival at Abbottabad 6-7 am. Breakfast break. Leave for Thandiani. Sight Seeing and Photography at Thandiani and other near spots. Leave for Nathia Gali. Shift to Hotel (K-international). Rest. BBQ and Bonfire. ',
  },
  {
    image: require('./../../images/our-work/pic2.jpg'),
    day: 2,
    title: 'Move towards Miranjani',
    desc:
      'Breakfast at Nathia Gali 7:00am. Move Towards Miranjani. Sight Seeing and Photography at Miranjani and other near spots.(2-3 hours). Drive Towards Islamabad. Lunch cum dinner at Monal. Drive Back to Lahore. Meals: Breakfast and Dinner. End of Services ',
  },
];
                ...
                <div className='col-lg-8'>
                  <div className='d-flex info-bx m-b30'>
                    <div className='tour-title'>
                      <h2>Tour to Thandiani and Miranjani</h2>
                      <p>
                        Miranjani peak, is a point for hiking enthusiasts that
                        offers owe-inspiring views of the sky-high mountains and
                        valleys around. Miranjani peak, is a point for hiking
                        enthusiasts that offers owe-inspiring views of the
                        sky-high mountains and valleys around.
                      </p>
                      <p>
                        <span className='site-button button-sm'>2 Days</span>{' '}
                    ...
                    <div className='tour-price ml-auto'>
                      ...
                      <h2 className='price'>Rs.5,500</h2>
                      <h4 className='actual-price'>Rs.7,500</h4>
                    </div>
                  </div>
                  ...
                  <div className='tour-days'>
                    ...
                    <p>
                      HighOnTour presents 2 days’ tour towards Thandiani and
                      Miranjani. Travelling Cost from. Travel in Private
